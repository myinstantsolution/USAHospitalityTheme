...
<div class="customerPageBorderBg">
    ...
    {if isset($id_address) && (isset($smarty.post.alias) || isset($address->alias))}
        ...
        {/if}
    {else}
        <p class="pText">{l s='To add a new address, please fill out the form below.'}</p>
    {/if}
    </h3>
    ...
    <form action="{$link->getPageLink('address', true)}" method="post" class="std" id="add_address">
        <fieldset>
            <h3 class="greenTitleText">{if isset($id_address)}{l s='Your address'}{else}{l s='New address'}{/if}</h3>

...
<div class="block myaccount">
	<div class="footerSections">
		<p class="title_block_footer"><a id="title_block_footer_link" href="{$link->getPageLink('my-account', true)}" title="{l s='Manage my customer account' mod='blockmyaccountfooter'}" rel="nofollow">{l s='My Account' mod='blockmyaccountfooter'}</a></p>	

...
<div class="customerPageBorderBg">
    <h1 class="titleBar" {if isset($instantSearch) && $instantSearch}id="instant_search_results"{/if}>
    ...
    {else}
        <h3 class="nbresult"><span class="pText">{if $nbProducts == 1}{l s='%d result has been found.' sprintf=$nbProducts|intval}{else}{l s='%d results have been found.' sprintf=$nbProducts|intval}{/if}</span></h3>
